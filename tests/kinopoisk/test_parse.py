...
@pytest.mark.parametrize('item_file, exp_result',
                         [('kinopoisk_series_item.html',
                          ('Во все тяжкие', 'Breaking Bad', 2008, 10)),
                          ('kinopoisk_miniseries_item.html',
                          ('Чернобыль', 'Chernobyl', 2019, None)),
                          ('kinopoisk_movie_item.html',
                          ('Белфегор – призрак Лувра', 'Belphégor - Le fantôme du Louvre', 2001, 5)),
                          ('kinopoisk_rus_movie_item.html',
                          ('Бриллиантовая рука', None, 1968, 9)),
                          ('kinopoisk_watched_item.html',
                          ('Остров собак', 'Isle of Dogs', 2018, None))])
